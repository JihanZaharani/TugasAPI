...
public class DataFramework implements Serializable{
    String nameFramework, original_author, official_web,  description, image;

    public DataFramework(String nameFramework, String original_author, String official_web, String description, String image) {
